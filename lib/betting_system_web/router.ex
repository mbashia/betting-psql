defmodule BettingSystemWeb.Router do
  ...
  scope "/", BettingSystemWeb do
    pipe_through [:browser, :require_authenticated_admins]
    ...
    live "/users/:id/view_user", UserLive.Index, :view_user
    ...
    live "/games/completed", GameLive.Completed, :index

    live "/games/:id", GameLive.Show, :show
    live "/games/:id/show/edit", GameLive.Show, :edit

    live "/user/bets/:id", BetsLive.Index, :index
    live "/user/bets-history/", BetsLive.UserHistory, :index
